...
КТО ЧТО ВЕДЁТ (зафиксировано Эльнуром 19.09.2026, после того как я переспросил третий раз):
Дарья работает В ОСНОВНОМ НА ПРОДАЖАХ, наравне с Эльнуром, и её каналы участвуют в
исходящих на тех же правах. Аренда и управление тоже на ней, но там в основном ведёт ИИ
и при необходимости передаёт живой Дарье. Ограничения «Дарья только про аренду» НЕТ и
никогда не было: писать покупателям от её лица можно и нужно."""
