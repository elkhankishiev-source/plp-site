...
/* 23.09.2026: страница гостя. Своей шапки и подвала сайта у неё нет намеренно —
   это одна дверь на одно дело, как страница оффера. Но общий блок «цвет системных
   полей браузера» ей нужен, иначе фон на телефоне будет мигать своим чередом.
   Маркеров, которых в файле нет, вставка не касается. */
const targets = [['index.html', 'site'], ['owner.html', 'cabinet'],
                 ['add-property.html', 'site'], ['guest.html', 'site'],
