...
const pages=[
 ...
 /* 21.09: секции выбираем ПО ИМЕНИ, а не по номеру. Номера 8 и 9 означали квиз и
    «наш подход»; после перестановки блоков главной они бы съехали на чужие
    разделы, и страница покупки собралась бы из случайных кусков. */
 {file:'buy.html',self:'sale',sections:['sale','quiz','do','all-objects'],catalogCar:'saleCar',
 ...
 /* Эльнур 20.09: «карточки продажи и аренда, почему они отличаются, пусть аренда
    будет в таком же стиле, что и продажа». Отличались не карточки — состав страницы:
    у покупки была раскладка каталога, квиз, подход и список объектов, а у аренды
    только голая лента. Теперь состав один и тот же. */
 {file:'rent.html',self:'rent',sections:['rent','quiz','do','all-objects'],catalogCar:'rentCar',
