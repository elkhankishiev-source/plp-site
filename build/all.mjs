...
const steps = ['mkog.mjs', 'gen.mjs', 'mkshared.mjs', 'mkpages.mjs', 'mkdistricts.mjs', 'mkextra.mjs',
               'mkabout.mjs', 'mktheme.mjs', 'mkpreview.mjs', 'mklinks.mjs'];
...
if (!process.env.PLP_FAST) {
  for (const [tool, name] of [['tools/object_consistency.py', 'карточки'], ['tools/ui_parity.py', 'вид'], ['tools/cab_check.py', 'кабинет']]) {
    try {
